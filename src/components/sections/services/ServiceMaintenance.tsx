...
const contractPlans = [
  {
    ...
    bestFor: "Corporate offices, retail storefronts, medical clinics, gyms, and high-traffic family homes."
  },
  {
    title: "Bi-Weekly Plan",
    frequency: "Every two weeks",
    desc: "The ideal balance of consistent maintenance and excellent monthly value.",
    bestFor: "Mid-sized professional offices, design showrooms, local shops, and residential homes."
  },
  {
    title: "Monthly Plan",
...
export function ServiceMaintenance() {
  return (
    <section id="ongoing-contracts" className="py-20 lg:py-32 bg-muted/30 border-y border-border relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="md:w-2/3">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-5xl mb-4">
              Ongoing Maintenance Cleaning Contracts
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              We offer recurring cleaning contracts for both commercial properties and residential homes. Whether it's an office, retail space, or your own home — weekly, bi-weekly, or monthly — we build a schedule around your space and your needs.
            </p>
