...
const HARDCODED_ITEMS: GalleryItem[] = [
  ...
  { id: "tricar-const-1", category: "post-construction", title: "Tricar — Phase 1 Construction Clean", desc: "Phase 1 post-construction clean underway — debris cleared, drywall dust extracted, and surfaces prepped before PDI.", location: "Guelph, ON", image: "/images/portfolio/tricar-guelph-const-1.jpeg", alt: "Phase 1 post-construction clean in progress at Tricar 1882 Gordon Street Guelph" },
  ...
  { id: "tricar-area-2", category: "commercial", title: "Tricar — Common Area Clean in Progress", desc: "Crew working through the common area corridor — floor scrubbing, wall wipe-down, and wet-floor safety protocol in place.", location: "Guelph, ON", image: "/images/portfolio/tricar-guelph-area-2.jpeg", alt: "Worker cleaning common area corridor at Tricar 1882 Gordon Street Guelph Ontario" },
  { id: "tricar-area-3", category: "commercial", title: "Tricar — Corridor Completed", desc: "Long common area hallway after a thorough clean — every surface wiped, floors polished edge-to-edge.", location: "Guelph, ON", image: "/images/portfolio/tricar-guelph-area-3.jpeg", alt: "Long clean corridor at Tricar 1882 Gordon Street Guelph Ontario" },
  ...
  { id: "res-sink", category: "residential", title: "Residential Deep Clean — Under-Sink", desc: "Even the spaces no one sees — under-sink cabinet completely cleaned out and sanitized as part of a full residential deep clean.", location: "Southern Ontario", image: "/images/portfolio/residential-sink-ba.png", alt: "Before and after under-sink cabinet clean by Red and White Cleaning Services" },
  { id: "gen-1", category: "specialty", title: "71 Wyndham — Generator Room Clean", desc: "Mechanical room deep clean — generator units detailed, floors swept and mopped, and all surfaces wiped around active equipment.", location: "71 Wyndham Street, Guelph, ON", image: "/images/portfolio/generator-1.jpg", alt: "Worker cleaning generator equipment in mechanical room at 71 Wyndham Guelph" },
