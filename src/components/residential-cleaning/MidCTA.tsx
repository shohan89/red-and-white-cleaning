...
export function MidCTA() {
  return (
    <section className={styles.midCta} aria-label="Book a home clean">
      <div className={styles.container}>
        <div className={styles.midCtaInner}>
          <div>
            <h2 className={styles.midCtaTitle}>Need a House Cleaner Near You?</h2>
            <p className={styles.midCtaText}>
              Fast, friendly quotes for move-in/move-out, pre-sale, deep
              cleans and recurring home cleaning across Kitchener&ndash;Waterloo
