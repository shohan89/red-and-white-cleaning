...
export function FinalCTA() {
  return (
    <section className={styles.finalCta} aria-label="Book your home clean">
      ...
      <div className={styles.container}>
        <div className={styles.finalCtaInner}>
          <h2 className={styles.finalCtaTitle}>
            Ready to Book a House Cleaner Near You?
          </h2>
          <p className={styles.finalCtaSubtitle}>
            Free, no-obligation quotes for move-in/move-out, pre-sale, deep or recurring home cleaning &mdash; replies the same business day.
          </p>
