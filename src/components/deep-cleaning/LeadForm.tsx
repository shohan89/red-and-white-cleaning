...
const SERVICE_OPTIONS = [
  "Whole Home Deep Clean (One-Off)",
  "Kitchen Deep Clean",
  "Bathroom Deep Clean",
  "Move-In / Move-Out Cleaning",
  "Airbnb Deep Clean",
  "After-Event / Post-Reno Clean-Up",
  "Seasonal / Annual Deep Clean",
  "Recurring Cleaning",
];
...
export function LeadForm() {
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("/api/deep-cleaning-lead", {
        method: "POST",
  ...
  return (
    <div className={styles.glassCard}>
      ...
      <p className={styles.glassSubtitle}>
        Tell us about your deep cleaning or move out cleaning needs — we&rsquo;ll follow up fast, usually the same day.
      </p>
